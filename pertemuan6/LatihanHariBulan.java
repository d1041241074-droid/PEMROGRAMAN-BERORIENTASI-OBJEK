...
public class LatihanHariBulan {
    public static void main(String[] args) {
        ...
        switch (month) { //untuk mengambil outputan Bulan : (nama bulan) (bulan ke-(bulan keberapa))
            case 1: 
            ...
            case 12: 
                ...
                break;
            default: //di switch kedua tidak perlu ini lagi karena akan redundant
                System.out.println("Bulan tidak valid");
                return;
        }

        switch (month) { //switch dengan fall through untuk bulan dengan hari yang sama
            case 1:
            case 3:
            case 5:
            case 7:
